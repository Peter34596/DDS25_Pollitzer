...
public class PagoCompletoGastos extends CriterioLiquidacion {
    @Override
    ...
    public double[] dividirExpensas(Map<String, Double> gastosAgrupados, double porcentajeUf, double saldoBancario) {
        double montoOrdUf = gastosAgrupados.get("ordinarios") * porcentajeUf;
        double montoExtUf = gastosAgrupados.get("extraordinarios") * porcentajeUf;
